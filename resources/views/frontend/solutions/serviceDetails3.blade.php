                        ...
                        <div class="service-sidebar mr_40">
                            <div class="category-widget mb_40">
                                <ul class="category-list clearfix">
                                    ...
                                    <li><a href="{{ route('serviceDetails3') }}" class="current">Career Growth <i class="icon-42"></i></a></li>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="service-details-content">
                            <div class="sec-title mb_70">
                                <span class="sub-title mb_10">Career Growth</span>
                            ...
                            <figure class="image-box mb_30"><img src="{{ asset('assets/images/service/service-10.jpg') }}" alt=""></figure>
