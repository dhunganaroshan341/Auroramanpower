                ...
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content_block_one">
                        <div class="content-box mr_80">
                            ...
                            <div class="text-box">
                                <p>Moreover embracing diversity and inclusion can enhance employee engagement and morale.
                                    They are more likely</p>
                            ...
                            <div class="btn-box"><a href="{{ route('about') }}" class="theme-btn btn-one"><span>Find
                                        Works</span></a></div>
                        </div>
                    </div>
                </div>
