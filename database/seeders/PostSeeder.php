    ...
    public function run(): void
    {
        $posts = [
            [
                ...
                'description' => 'Nepal has a growing workforce eager to explore opportunities abroad. Countries in the Gulf region and Southeast Asia are constantly seeking skilled and semi-skilled labor, offering competitive salaries and better living standards.
...
Before embarking on a journey abroad, workers should ensure proper documentation, training, and understanding of labor laws in the host country. With proper preparation, migrating for work can be a life-changing opportunity.',
            ...
            [
                ...
                'description' => 'Working abroad can be a rewarding experience if approached carefully. Nepali workers planning to move to Gulf countries or other destinations should consider the following:
...
With the right preparation, working abroad can be an enriching experience, opening doors to professional growth and financial security.',
            ...
            [
                ...
                'description' => 'Nepali workers have become highly valued in Gulf and other foreign countries due to their strong work ethic, adaptability, and dedication. Sectors like construction, healthcare, hospitality, and domestic services are experiencing a surge in demand.
